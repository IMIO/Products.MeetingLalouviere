...
class testCustomMeeting(MeetingLalouviereTestCase):
    ...
    def test_getCommissionCategoriesIds(self):
        ...
        categories = ('commission-cadre-de-vie-et-logement', 'commission-finances-et-patrimoine',
         ...
         'commission-ag-1er-supplement', 'commission-finances-1er-supplement', 'commission-enseignement-1er-supplement',
         'commission-culture-1er-supplement', 'commission-sport-1er-supplement', 'commission-sante-1er-supplement',
         'commission-police-1er-supplement', 'commission-cadre-de-vie-1er-supplement', 'commission-patrimoine-1er-supplement',
         'commission-travaux-1er-supplement', 'commission-speciale-1er-supplement',)
        ...
        self.assertTupleEqual(meeting2009.adapted().getCommissionCategoriesIds(),
                              ('commission-travaux', 'commission-enseignement','commission-cadre-de-vie-et-logement',
                               'commission-ag', 'commission-finances-et-patrimoine', 'commission-police',
                               'commission-speciale',))

        self.assertTupleEqual(meeting2014.adapted().getCommissionCategoriesIds(),
                              ('commission-travaux', ('commission-ag', 'commission-finances', 'commission-enseignement',
                                'commission-culture', 'commission-sport', 'commission-sante',),
                               ('commission-cadre-de-vie', 'commission-patrimoine',),
                               'commission-police', 'commission-speciale',))

        self.assertTupleEqual(meeting2019.adapted().getCommissionCategoriesIds(),
                              (('commission-travaux', 'commission-finances'),
                               ('commission-ag', 'commission-enseignement', 'commission-culture', 'commission-sport',
                                'commission-sante',),
                               ('commission-cadre-de-vie', 'commission-patrimoine',),
                               'commission-police', 'commission-speciale',))

        self.assertTupleEqual(meeting2050.adapted().getCommissionCategoriesIds(),
                              (('commission-travaux', 'commission-finances'),
                               ('commission-ag', 'commission-enseignement', 'commission-culture', 'commission-sport',
                                'commission-sante',),
                               ('commission-cadre-de-vie', 'commission-patrimoine',),
